...
public class InfageBlocks {
	...
	public InfageBlocks() {
		// 注册这些方块
		Registry.register(Registry.BLOCK, new Identifier(InfageSettings.NAMESPACE, Computer.BLOCK_ID), COMPUTER);
		Registry.register(Registry.BLOCK, new Identifier(InfageSettings.NAMESPACE, Switch.BLOCK_ID), SWITCH);
		Registry.register(Registry.BLOCK, new Identifier(InfageSettings.NAMESPACE, Disk.BLOCK_ID), DISK);
		Registry.register(Registry.BLOCK, new Identifier(InfageSettings.NAMESPACE, ItemGenerator.BLOCK_ID), ITEM_GENERATOR);
		Registry.register(Registry.BLOCK, new Identifier(InfageSettings.NAMESPACE, ItemRegester.BLOCK_ID), ITEM_REGESTER);
		Registry.register(Registry.BLOCK, new Identifier(InfageSettings.NAMESPACE, PowerController.BLOCK_ID), POWER_CONTROLLER);
		Registry.register(Registry.BLOCK, new Identifier(InfageSettings.NAMESPACE, PowerSensor.BLOCK_ID), POWER_SENSOR);
	}
}
